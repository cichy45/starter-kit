		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DC_App",
									"targetURL": "#stkstarterkitdc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"stkstarterkitdc-display": {
								"semanticObject": "stkstarterkitdc",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=stk.starterkitdc",
									"url": sap.ui.require.toUrl("stk/starterkitdc")
								}
							}
						}
					}
